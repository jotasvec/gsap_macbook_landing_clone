...
Files: macbook-14.glb [629.72KB] > /Users/jotasvec/Develop/playground/macsite_clone/public/models/macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        // Change color only when the part name isn't noChangeParts 
...
useGLTF.preload('/model/macbook-14-transformed.glb')
